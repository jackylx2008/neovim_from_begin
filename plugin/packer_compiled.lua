...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "LuaSnip", "cmp-cmdline", "friendly-snippets", "cmp-nvim-lua", "cmp-path", "cmp-buffer", "cmp-treesitter", "cmp_luasnip", "cmp-spell" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-dap', 'nvim-bufferline.lua', 'trouble.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
