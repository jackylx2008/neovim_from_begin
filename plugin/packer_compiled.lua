...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "friendly-snippets", "cmp-cmdline", "cmp-nvim-lua", "cmp-path", "cmp-spell", "cmp-treesitter", "cmp-buffer", "cmp_luasnip", "LuaSnip" },
  ...
  ["quick-scope"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/quick-scope",
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-cmp', 'nvim-ts-autotag', 'vim-surround', 'nvim-treesitter-endwise'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
