...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'which-key.nvim', 'hop.nvim', 'Comment.nvim', 'lualine.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
