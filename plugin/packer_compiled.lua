...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-treesitter", "friendly-snippets", "cmp_luasnip", "cmp-buffer", "cmp-nvim-lua", "cmp-spell", "LuaSnip", "cmp-cmdline", "cmp-path" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-bufferline.lua'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-treesitter-endwise', 'vim-surround', 'nvim-cmp', 'nvim-ts-autotag'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'which-key.nvim', 'hop.nvim', 'indent-blankline.nvim', 'Comment.nvim', 'lualine.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
