...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "LuaSnip", "friendly-snippets", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-path", "cmp-spell", "cmp-treesitter" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'trouble.nvim', 'nvim-bufferline.lua', 'nvim-dap', 'gitsigns.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
