...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-treesitter", "LuaSnip", "cmp-nvim-lua", "cmp-buffer", "friendly-snippets", "cmp_luasnip", "cmp-cmdline", "cmp-spell", "cmp-path" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'which-key.nvim', 'Comment.nvim', 'lualine.nvim', 'hop.nvim', 'indent-blankline.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
