...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-path", "cmp-spell", "cmp_luasnip", "friendly-snippets", "cmp-treesitter", "cmp-nvim-lua", "LuaSnip" },
  ...
  ["nvim-dap"] = {
    after = { "nvim-dap-virtual-text", "DAPInstall.nvim", "nvim-dap-ui", "nvim-dap-python", "one-small-step-for-vimkind", "telescope-dap.nvim" },
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-dap', 'gitsigns.nvim', 'nvim-bufferline.lua', 'trouble.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'Comment.nvim', 'hop.nvim', 'indent-blankline.nvim', 'which-key.nvim', 'lualine.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-treesitter-endwise', 'nvim-cmp', 'vim-surround', 'nvim-ts-autotag'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
