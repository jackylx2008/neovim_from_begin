...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-nvim-lua", "cmp-path", "cmp-spell", "cmp-treesitter", "cmp_luasnip", "friendly-snippets", "LuaSnip" },
  ...
  ["nvim-surround"] = {
    ...
    loaded = true,
    path = "/Users/liuxin/.local/share/nvim/site/pack/packer/start/nvim-surround",
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'hop.nvim', 'indent-blankline.nvim', 'lualine.nvim', 'which-key.nvim', 'Comment.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-dap', 'nvim-bufferline.lua', 'gitsigns.nvim', 'trouble.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
