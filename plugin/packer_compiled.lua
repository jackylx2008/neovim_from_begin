...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-spell", "LuaSnip", "cmp-treesitter", "cmp_luasnip", "cmp-buffer", "friendly-snippets", "cmp-cmdline", "cmp-nvim-lua" },
  ...
  ["nvim-dap"] = {
    after = { "telescope-dap.nvim", "nvim-dap-python", "nvim-dap-virtual-text", "DAPInstall.nvim", "nvim-dap-ui", "one-small-step-for-vimkind" },
  ...
  ["nvim-surround"] = {
    ...
    loaded = true,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/start/nvim-surround",
